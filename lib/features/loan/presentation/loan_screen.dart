                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return AppCard(
                        ...
                        onTap: () {
                          ref.read(loanFlowProvider.notifier).selectProvider(provider);
                          context.push(RouteNames.loanEmi.replaceFirst(':providerId', provider.id));
                        },
                        child: ListTile(
                          leading: const CircleAvatar(
                            backgroundColor: AppColors.surfaceVariant,
                            child: Icon(Icons.real_estate_agent, color: AppColors.primaryBlue),
                          ),
