...
(async () => {
  try {
    ...
    console.log('\n====================================================');
    console.log('[READ-ONLY FORENSIC INSPECTION FOR RET000027 - YOGESH]');
    ...
    const targetUser = backupUsers.find(u => u.retailerId === 'RET000027' || u.phone === '8275528775');
    if (!targetUser) {
      console.error('RET000027 not found!');
      return;
    }

    const uId = String(targetUser._id);
    console.log(`User Found: ${targetUser.name} (${targetUser.phone}) | ID: ${uId} | RetailerCode: ${targetUser.retailerId || 'RET000027'}\n`);
