...
(async () => {
  try {
    ...
    console.log('\n====================================================');
    console.log('[READ-ONLY FORENSIC INSPECTION FOR RET000035 - YASHWANT KONDAGORLA]');
    ...
    const targetUser = backupUsers.find(u => u.retailerId === 'RET000035' || u.phone === '9404871043');
    if (!targetUser) {
      console.error('RET000035 not found!');
      return;
    }

    const uId = String(targetUser._id);
    console.log(`User Found: ${targetUser.name} (${targetUser.phone}) | ID: ${uId} | RetailerCode: ${targetUser.retailerId || 'RET000035'}\n`);
