...
(async () => {
  try {
    ...
    console.log('\n====================================================');
    console.log('[READ-ONLY FORENSIC INSPECTION FOR RET000013 - SRUJAN AKULA]');
    ...
    const targetUser = backupUsers.find(u => u.retailerId === 'RET000013' || u.phone === '7893666060');
    if (!targetUser) {
      console.error('RET000013 not found!');
      return;
    }

    const uId = String(targetUser._id);
    console.log(`User Found: ${targetUser.name} (${targetUser.phone}) | ID: ${uId} | RetailerCode: ${targetUser.retailerId || 'RET000013'}\n`);
