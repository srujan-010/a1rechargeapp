...
(async () => {
  try {
    ...
    console.log('\n====================================================');
    console.log('[READ-ONLY FORENSIC INSPECTION FOR RET000030 - SURESH AKULA]');
    ...
    const targetUser = backupUsers.find(u => u.retailerId === 'RET000030' || u.phone === '9421727855');
    if (!targetUser) {
      console.error('RET000030 not found!');
      return;
    }

    const uId = String(targetUser._id);
    console.log(`User Found: ${targetUser.name} (${targetUser.phone}) | ID: ${uId} | RetailerCode: ${targetUser.retailerId || 'RET000030'}\n`);
