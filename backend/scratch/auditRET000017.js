...
(async () => {
  try {
    ...
    console.log('\n====================================================');
    console.log('[READ-ONLY FORENSIC INSPECTION FOR RET000017 - ANIL AKULA]');
    ...
    const targetUser = backupUsers.find(u => u.retailerId === 'RET000017' || u.phone === '9849666060');
    if (!targetUser) {
      console.error('RET000017 not found!');
      return;
    }

    const uId = String(targetUser._id);
    console.log(`User Found: ${targetUser.name} (${targetUser.phone}) | ID: ${uId} | RetailerCode: ${targetUser.retailerId || 'RET000017'}\n`);
