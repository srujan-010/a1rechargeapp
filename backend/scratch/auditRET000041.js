...
(async () => {
  try {
    ...
    console.log('\n====================================================');
    console.log('[READ-ONLY FORENSIC INSPECTION FOR RET000041 - RAJANNA MADANAYYA KONDRA]');
    ...
    const targetUser = backupUsers.find(u => u.retailerId === 'RET000041' || u.phone === '9405118660');
    if (!targetUser) {
      console.error('RET000041 not found!');
      return;
    }

    const uId = String(targetUser._id);
    console.log(`User Found: ${targetUser.name} (${targetUser.phone}) | ID: ${uId} | RetailerCode: ${targetUser.retailerId || 'RET000041'}\n`);
