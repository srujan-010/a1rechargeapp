...
(async () => {
  try {
    ...
    console.log('\n====================================================');
    console.log('[READ-ONLY FORENSIC INSPECTION FOR RET000018 - UPENDER]');
    ...
    const targetUser = backupUsers.find(u => u.retailerId === 'RET000018' || u.phone === '9949666060');
    if (!targetUser) {
      console.error('RET000018 not found!');
      return;
    }

    const uId = String(targetUser._id);
    console.log(`User Found: ${targetUser.name} (${targetUser.phone}) | ID: ${uId} | RetailerCode: ${targetUser.retailerId || 'RET000018'}\n`);
