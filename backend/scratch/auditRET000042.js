...
(async () => {
  try {
    ...
    console.log('\n====================================================');
    console.log('[READ-ONLY FORENSIC INSPECTION FOR RET000042 - NAGESHWAR SATYANARAYANA NERLAWAR]');
    ...
    const targetUser = backupUsers.find(u => u.retailerId === 'RET000042' || u.phone === '9573916413');
    if (!targetUser) {
      console.error('RET000042 not found!');
      return;
    }

    const uId = String(targetUser._id);
    console.log(`User Found: ${targetUser.name} (${targetUser.phone}) | ID: ${uId} | RetailerCode: ${targetUser.retailerId || 'RET000042'}\n`);
