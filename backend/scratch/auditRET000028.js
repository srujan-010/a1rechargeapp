...
(async () => {
  try {
    ...
    console.log('\n====================================================');
    console.log('[READ-ONLY FORENSIC INSPECTION FOR RET000028 - YOGESH AKULA]');
    ...
    const targetUser = backupUsers.find(u => u.retailerId === 'RET000028' || u.phone === '9888877777');
    if (!targetUser) {
      console.error('RET000028 not found!');
      return;
    }

    const uId = String(targetUser._id);
    console.log(`User Found: ${targetUser.name} (${targetUser.phone}) | ID: ${uId} | RetailerCode: ${targetUser.retailerId || 'RET000028'}\n`);
