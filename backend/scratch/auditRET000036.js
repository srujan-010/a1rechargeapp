...
(async () => {
  try {
    ...
    console.log('\n====================================================');
    console.log('[READ-ONLY FORENSIC INSPECTION FOR RET000036 - NAGESH L ARIGELA]');
    ...
    const targetUser = backupUsers.find(u => u.retailerId === 'RET000036' || u.phone === '9550505193');
    if (!targetUser) {
      console.error('RET000036 not found!');
      return;
    }

    const uId = String(targetUser._id);
    console.log(`User Found: ${targetUser.name} (${targetUser.phone}) | ID: ${uId} | RetailerCode: ${targetUser.retailerId || 'RET000036'}\n`);
